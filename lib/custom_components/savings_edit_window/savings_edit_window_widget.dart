...
import 'savings_edit_window_model.dart';
export 'savings_edit_window_model.dart';

class SavingsEditWindowWidget extends StatefulWidget {
  const SavingsEditWindowWidget({super.key});

  @override
  State<SavingsEditWindowWidget> createState() =>
      _SavingsEditWindowWidgetState();
}

class _SavingsEditWindowWidgetState extends State<SavingsEditWindowWidget> {
  late SavingsEditWindowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavingsEditWindowModel());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FFButtonWidget(
            onPressed: () async {
              logFirebaseEvent('SAVINGS_EDIT_WINDOW_COMP_SAVE_BTN_ON_TAP');
