    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: Dashboardv3Widget.routePath,
          builder: (context, params) => Dashboardv3Widget(
            dashboardupdate: params.getParam(
              'dashboardupdate',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          ...
          path: ReceiptInputWidget.routePath,
          builder: (context, params) => ReceiptInputWidget(),
        )
                  ...
                  child: SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      valueColor: AlwaysStoppedAnimation<Color>(
                        FlutterFlowTheme.of(context).one,
                      ),
                    ),
                  ),
                )
